...
: ${AMENT_CURRENT_PREFIX:="/workspace/install/gz_ros_bridge"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gz_ros_bridge/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/gz_ros_bridge/environment/path.sh"
