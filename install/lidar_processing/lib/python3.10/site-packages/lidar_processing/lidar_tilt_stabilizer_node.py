...
Simple version: reads roll/pitch from ArduPilot SITL (MAVLink), and for each
...
ceiling get dropped (set to inf). Everything else is passed straight
through, in its ORIGINAL angle bin, on /scan_stabilized.
