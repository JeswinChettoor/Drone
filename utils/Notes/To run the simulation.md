...
sim_vehicle.py -v ArduCopter -f gazebo-iris   --model JSON   -w   --add-param-file=/workspace/test.parm   --out=udpout:127.0.0.1:15000   --out=udpout:127.0.0.1:15001   --console
